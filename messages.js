...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateMessageTyping() {
        const messages = [
            "Красивые с красивыми",
            "Тебя спустили с небес...",
            "Мне кажется, что мы уже живем вместе",
            "Эгосит...эксцентричный, гениальный, очаровательный...",
            "101 комплимент...",
            "Я хочу делать тебя счастливой.",
            "Спасибо тебе за все, просто за то, что ты есть",
            "Я хочу каждый день смотреть в твои карие глаза",
            "Не замерз, покушал?",
            "Я рада, что мы все обсудили, для меня это важно"
        ];
